...
@Component({
  selector: 'app-verificar-administrador',
  templateUrl: './verificar-administrador.component.html',
  styleUrls: ['./verificar-administrador.component.css']
})
export class VerificarAdministradorComponent {
  digits: string[] = ['', '', '', '', ''];
  ...
  onSubmit(): void {
    ...
    console.log('Navigating with usuario to administrador:', this.usuario);
              this.router.navigate(['/administrador'], { queryParams: { usuario: this.usuario } });
